        ...
        if (born != undefined) {
            born.targets.forEach(target => {
                if (
                    ...
                    target.morphTargetInfluences[target.index] =
                        value * target.weight * 0.01;
                }
            });
        }
    }
    ...
    private getTargets(
        ...
        binds.forEach((bind: VrmBlendshapeBind, index: number) => {
            ...
            if (bind.mesh != undefined) {
                ...
                target["morphTargetInfluences"] = this.getMorphTarget(
                    meshName.replace(".baked", ""),
                    scene
                );
